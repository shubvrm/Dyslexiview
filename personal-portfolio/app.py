...
def upload_image():
    ...
    if file:
        ...
        audio_filename1 = os.path.join('D:\Project Docs\web-dev-projects-main\web-dev-projects-main\personal-portfolio\src', '1.wav')
        tts.save(audio_filename1)

        tts = gTTS(original_text, lang='en')  # Adjust language if necessary
        # audio_filename = os.path.join(app.config['UPLOAD_FOLDER'], '1.wav')
        audio_filename2 = os.path.join('D:\Project Docs\web-dev-projects-main\web-dev-projects-main\personal-portfolio\src', '2.wav')
